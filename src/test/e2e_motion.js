...
const NUM_USERS = 41
const NUM_SEATS = 0
const ELECTION_TYPE = 1
const NAME_ELECTION = "M_TEST"

contract('Motion End-to-End', function(accounts) {
    ...
    it("should have added 2 motions", async function() {
        var c = await registration.getCounts()
        assert.equal(c[5], 2, "incorrect number of registered voters")
    })
